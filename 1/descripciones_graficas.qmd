...
municipios_tlaxcala <- st_read("datos2435_1/29mun.shp", options = "ENCODING=LATIN1", quiet = TRUE)


mapa_municipios <- ggplot(municipios_tlaxcala) +
  geom_sf(fill = "lightgreen", color = "white", size = 0.3) +
  labs(
    title = "Municipios de Tlaxcala",
    subtitle = paste("Total de municipios:", nrow(municipios_tlaxcala)),
...
datos_total <- read_csv("datos2435_1/cpv_valor_29.csv", na = c("ND"))
...
datos <- left_join(municipios_tlaxcala, datos)
```
...
ggplot(datos) +
  ...
  labs(
    title = "Edad (mediana) de los Municipios de Tlaxcala",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(data = datos, aes(x = "", y = edad_mediana)) +
  ...
  subtitle = "Población del Estado de Tlaxcala",
  y = "Edad (años)",
  x = "")+
  theme_bw()+
  theme(
...
ggplot(data = datos, aes(sample = edad_mediana)) +
    ...
    subtitle = "Edad Mediana - Población Tlaxcala") +
    theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
    legend.text = element_text(size=13),
...
ggplot(datos) +
  ...
  labs(
    title = "Derechohabientes IMSS (%) de los Municipios de Tlaxcala",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
...
ggplot(data = datos, aes(sample = porcentaje_de_la_poblacion_derechohabiente_en_el_imss)) +
    ...
    labs(title = "Gráfico Q-Q para Normalidad",
    subtitle = "Derechohabientes IMSS (%) - Tlaxcala") +
    theme_bw()+
    theme(
    legend.title = element_text(size=13, face="bold"),
    legend.text = element_text(size=13),
...
ggplot(datos) +
  ...
  labs(
    title = "Población de los Municipios de Tlaxcala",
    caption = "Fuente: INEGI - Marco Geoestadístico"
  ) +
  theme_void() +
  theme(
